        ...
        <div class="card-body">
            <form method="POST" action="{{route("user.update", [$user])}}">
                ...
                <div class="form-group col-md-8">
                    ...
                    <input name="password" type="password" class="form-control" value="{{$user->password}}" id="password" value="{{ old('password') }} " >
                </div>
                ...
                <div class="form-group col-md-8">
                    ...
                    value="{{ old('cedula') }}" placeholder="Ingrese nueva contraseña">
                </div>
                ...
                <div class="form-group col-md-8">
                    ...
                    <input name="edad" type="number" class="form-control"  value="{{$user->edad}}" id="edad"value="{{ old('edad') }}">
                </div>
